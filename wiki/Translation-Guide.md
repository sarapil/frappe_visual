...
```bash
bench --site dev.localhost get-untranslated ar --app frappe_visual
```

### 2. Translation file format — تنسيق ملف الترجمة

File: `frappe_visual/translations/ar.csv`
...
bench --site dev.localhost get-untranslated ar --app frappe_visual | wc -l
```
...
2. Edit/create the CSV file in `frappe_visual/translations/`
