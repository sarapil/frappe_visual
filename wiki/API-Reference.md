...
All Frappe Visual APIs follow the Arkan Lab API standards.

## Base URL — الرابط الأساسي

```
POST /api/method/frappe_visual.api.v1.<module>.<function>
```
...
```bash
curl -X POST 'https://site.example.com/api/method/frappe_visual.api.v1.records.get_list' \
