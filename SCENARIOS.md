# Frappe Visual — Scenarios & Impact Matrix

> **فرابي فيجوال** — مكتبة المكونات المرئية
> DocTypes: ~1 | APIs: ~11 | Modules: 1
...
> Total `@frappe.whitelist()` endpoints: ~11
